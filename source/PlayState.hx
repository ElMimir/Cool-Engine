...
class PlayState extends MusicBeatState
{
	...
	var coolEngineWatermark:FlxText;
	...
	override public function create()
	{
		...
		// Add Cool watermark
		coolEngineWatermark = new FlxText(4,healthBarBG.y + 50,0,SONG.song + " - " + CoolUtil.difficultyFromInt(storyDifficulty) + (Main.watermarks ? " | KE " + MainMenuState.coolEngineVer : ""), 16);
		coolEngineWatermark.setFormat(Paths.font("vcr.ttf"), 16, FlxColor.WHITE, RIGHT, FlxTextBorderStyle.OUTLINE,FlxColor.BLACK);
		coolEngineWatermark.scrollFactor.set();
		add(coolEngineWatermark);

		if (PlayStateChangeables.useDownscroll)
			coolEngineWatermark.y = FlxG.height * 0.9 + 45;
		...
		coolEngineWatermark.cameras = [camHUD];
		if (loadRep)
	...
	override public function update(elapsed:Float)
	{
		...
		if (executeModchart && luaModchart != null && songStarted)
		{
			...
			if (luaModchart.getVar("showOnlyStrums",'bool'))
			{
				...
				coolEngineWatermark.visible = false;
			...
			else
			{
				...
				coolEngineWatermark.visible = true;
